...
app.put("/users/:id", (request, response) => {
	...
	O ultimo tipo de parâmetro body(corpo da requisição) que é um dos mais importantes... Ele serve tanto para quando queremos criar um novo usuário, quanto editar um usuário, ou qualquer outro tipo de recurso ( formato JSON (formato mundial) )...

	Vamos partir do exemplo que quero criar um usuário (POST)
	
	Adicionar em Body que será efetuado pelo formato JSON, e preencher o JSON...
...
// É necessário informar ao express para ele utilizar o formato JSON
app.use(express.json());

// EXEMPLO ==> Pegando dados criados pelo INSOMNIA
app.post("/users", (request, response) => {
	// request.body => Acessar corpo da requisição (para a criação quanto edição de registro)

	// Como request.body já é um JSON, podemos retorná-lo por completo, sem a necessidade de criar um novo objeto...
